...
/** Моды. Конфигурация. */
const appModsConfigPath = 'mods';

/** Моды. Конфигурация. Маршрут. Путь. */
export const appModsConfigRoutePath = appModsConfigPath;

/** Моды. Конфигурация. Полный путь. */
export const appModsConfigFullPath = `/${appModsConfigPath}`;

/** Моды. Конфигурация. Мод "Auth". Маршрут. Путь. */
export const appModsConfigModAuthPath = 'auth';
