...
{
    /// <summary>
    /// Данные. База данных. Загрузчики. Сущность "Product".
    /// </summary>
    public class DataDbLoaderProduct : DataBaseLoaderProduct, ICoreBaseDataDbLoader
    {
        #region Constructors
        ...
        public DataDbLoaderProduct(DataBaseObjectProduct data = null)
