...
import {AppModProductJobItemGetInput} from '../get/mod-product-job-item-get-input';

/** Мод "Product". Задания. Элемент. Удаление. Сервис. */
@Injectable({
  providedIn: 'root'
})
export class AppModProductJobItemDeleteService {
