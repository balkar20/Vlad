...
- для продуктовой среды: **Vlad2020.Apps.IdentityServer.Web/bin/Release/net6.0/publish**;

- для тестовой среды: **Vlad2020.Apps.IdentityServer.Web/bin/Test/net6.0/publish**.
