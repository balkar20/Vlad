...
/** Мод "DummyMain". Страницы. Элемент. Местоположение. */
export class AppModDummyMainPageItemLocation extends AppCoreCommonPageLocation<AppModDummyMainPageItemParameters> {
}
