...
{
    /// <summary>
    /// Данные. База данных. Загрузчики. Сущность "ProductCategory".
    /// </summary>
    public class DataDbLoaderProductCategory : DataBaseLoaderProductCategory, ICoreBaseDataDbLoader
    {
        #region Constructors
        ...
        public DataDbLoaderProductCategory(DataBaseObjectProductCategory data = null)
