...
namespace Vlad2020.Mods.DummyMain.Base.Jobs.Option.ProductCategory.List.Get
{
    /// <summary>
    /// Мод "DummyMain". Задания. Вариант выбора. Сущность "DummyManyToMany". Список. Получение. Сервис.
    /// </summary>
    public class ModDummyMainBaseJobOptionProductCategoryListGetService : CoreBaseExecutableServiceAsyncWithOutput
        <
        ...
        >
    {
        ...
        public ModDummyMainBaseJobOptionProductCategoryListGetService(
